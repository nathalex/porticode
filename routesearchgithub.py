import random
import csv
#import holdSummitCoordinates
#import climberInputs

govind = []
height = 200#climberInputs.height
legLength = 200#climberInputs.legLength
LeftHand = (0,0)
RightHand = (0,0)

def chooseStart(holds):
    holds.sort()
    (LeftFoot, RightFoot) = (holds[0], holds[1])
...
holds = getHolds(250)#holdSummitCoordinates.coordinates
...
(LeftFoot, RightFoot) = chooseStart(holds)
atTop = False
steps = 0
RightHand = None
rhb = None
